...
- 注册账号链路：支持临时邮箱、Remail 接码邮箱、GPTMail、Outlook Token 邮箱池和 Microsoft plus alias，提供验证码等待、注册进度、邮箱池状态和实时日志。
...
- 注册账号支持临时邮箱、Remail 接码邮箱、GPTMail、Outlook Token 邮箱池、Microsoft passwordless 验证和 plus alias 分裂。
