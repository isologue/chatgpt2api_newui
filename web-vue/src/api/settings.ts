...
const SETTINGS_SAVE_KEYS = [
  ...
  'image_egress_fallback_on_stream_timeout',
  'image_egress_circuit_breaker_enabled',
  'image_egress_failure_threshold',
  'image_egress_failure_window_seconds',
  'image_egress_cooldown_seconds',
...
export function normalizeSettings(raw: RawSettings | null | undefined): Settings {
  ...
  const normalized = {
    ...
    thread_pool_capacity: numberValue(source.thread_pool_capacity, 80, 1),
    ...
    image_egress_fallback_on_stream_timeout: boolValue(source.image_egress_fallback_on_stream_timeout, true),
    image_egress_circuit_breaker_enabled: boolValue(source.image_egress_circuit_breaker_enabled, true),
    image_egress_failure_threshold: numberValue(source.image_egress_failure_threshold, 3, 1),
    image_egress_failure_window_seconds: numberValue(source.image_egress_failure_window_seconds, 60, 1),
    image_egress_cooldown_seconds: numberValue(source.image_egress_cooldown_seconds, 120, 1),
    ...
    image_no_account_wait_seconds: numberValue(source.image_no_account_wait_seconds, 10, 0),
    image_no_quota_wait_seconds: numberValue(source.image_no_quota_wait_seconds, 10, 0),
...
function toBackendSettings(settings: Settings): RawSettings {
  ...
  const payload: RawSettings = {
    ...
    thread_pool_capacity: numberValue(normalized.thread_pool_capacity, 80, 1),
    ...
    image_egress_fallback_on_stream_timeout: boolValue(normalized.image_egress_fallback_on_stream_timeout, true),
    image_egress_circuit_breaker_enabled: boolValue(normalized.image_egress_circuit_breaker_enabled, true),
    image_egress_failure_threshold: numberValue(normalized.image_egress_failure_threshold, 3, 1),
    image_egress_failure_window_seconds: numberValue(normalized.image_egress_failure_window_seconds, 60, 1),
    image_egress_cooldown_seconds: numberValue(normalized.image_egress_cooldown_seconds, 120, 1),
    ...
    image_no_account_wait_seconds: numberValue(normalized.image_no_account_wait_seconds, 10, 0),
    image_no_quota_wait_seconds: numberValue(normalized.image_no_quota_wait_seconds, 10, 0),
